...
def carbonSolve(pe):
    ...
    mp = 12 * 1.6726219e-27 #particlemass - in this case proton
    z = 6 #charge in multiples of electron
    c = 299792458 #speed of  light

    ke_p = 12 * pe * 1e6 * e #proton energy(converted from MeV ie.150MeV)
...
selected_energies = pd.read_csv('data/carbon_energies.txt', header=None).to_numpy().reshape(-1)
Rs =[]
...
df.to_csv('data/carbon_range.csv')